...
Examples:
  checkout.sh aaronmorris-dev/dspy-base-lm
  checkout.sh github.com/aaronmorris-dev/dspy-base-lm
  checkout.sh https://github.com/aaronmorris-dev/dspy-base-lm
  checkout.sh git@github.com:aaronmorris-dev/dspy-base-lm.git
